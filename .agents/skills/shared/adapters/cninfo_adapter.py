...
def _make_evidence(
    ...
    evidence = _shared_make_evidence(
        field, value, source_desc,
        source_type="cninfo_official", tier=0, url=url, confidence=confidence,
    )
    evidence["announcement_title"] = announcement_title
